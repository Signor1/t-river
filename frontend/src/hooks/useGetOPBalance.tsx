...
export const useGetOPBalance = (address: any) => {
    ...
    useEffect(() => {
        ...
        wssProvider.getLogs({ ...depositfilter, fromBlock: 5810246 }).then((events) => {
        ...
        wssProvider.getLogs({ ...withdrawfilter, fromBlock: 5810246 }).then((events) => {
        ...
        wssProvider.getLogs({ ...feefilter, fromBlock: 5810246 }).then((events) => {
        ...
        wssProvider.getLogs({ ...subfilter, fromBlock: 5810389 }).then((events) => {
